...
(
   ...
   block_hash varchar
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_arbitrum_logs',
...
SET 'pipeline.name' = 'arbitrum_logs_sync';


-- submit job
insert into iceberg.beta_bronze.arbitrum_logs
select
