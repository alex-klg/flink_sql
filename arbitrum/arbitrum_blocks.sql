...
CREATE TABLE kf_arbitrum_blocks
(
   ...
   number int
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_arbitrum_blocks',
...
SET 'pipeline.name' = 'arbitrum_blocks_sync';


-- submit job
insert into iceberg.beta_bronze.arbitrum_blocks
select
    base_fee_per_gas,
    transaction_count,
