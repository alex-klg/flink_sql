...
CREATE TABLE kf_polygon_blocks
(
   ...
   number int
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_polygon_blocks',
...
SET 'pipeline.name' = 'polygon_blocks_sync';


-- submit job
insert into iceberg.beta_bronze.polygon_blocks
select
    base_fee_per_gas,
    transaction_count,
