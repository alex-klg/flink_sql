...
-- Define table
-- 在 trino 执行 show ca
CREATE TABLE kf_polygon_transactions
(
   hash STRING,
   nonce bigint,
   ...
   receipt_effective_gas_price bigint
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_polygon_transactions',
...
SET 'pipeline.name' = 'polygon_transactions_sync';

insert into iceberg.beta_bronze.polygon_transactions
select
