...
CREATE TABLE kf_avalanche_blocks
(
   ...
   number int
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_avalanche_blocks',
...
SET 'pipeline.name' = 'avalanche_blocks_sync';


-- submit job
insert into iceberg.beta_bronze.avalanche_blocks
select
    base_fee_per_gas,
    transaction_count,
