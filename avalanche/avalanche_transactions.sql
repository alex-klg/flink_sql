...
-- Define table
-- 在 trino 执行 show ca
CREATE TABLE kf_avalanche_transactions
(
   hash STRING,
   nonce bigint,
   ...
   receipt_effective_gas_price bigint
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_avalanche_transactions',
...
SET 'pipeline.name' = 'avalanche_transactions_sync';

insert into iceberg.beta_bronze.avalanche_transactions
select
...
from kf_avalanche_transactions;