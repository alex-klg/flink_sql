...
CREATE TABLE kf_avalanche_logs
(
   log_index bigint,
   ...
   block_hash varchar
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_avalanche_logs',
...
SET 'pipeline.name' = 'avalanche_logs_sync';


-- submit job
insert into iceberg.beta_bronze.avalanche_logs
select
