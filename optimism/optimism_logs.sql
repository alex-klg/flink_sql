...
(
   ...
   block_hash varchar
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_optimism_logs',
...
SET 'pipeline.name' = 'optimism_logs_sync';


-- submit job
insert into iceberg.prod_bronze.optimism_logs
select
