...
CREATE TABLE kf_optimism_token_transfers
(
   ...
   block_hash varchar
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_optimism_token_transfers',
...
-- select block_timestamp_p, amount_raw, `value` from kf_optimism_token_transfers;
...
SET 'pipeline.name' = 'optimism_token_transfers_sync';


-- submit job
insert into iceberg.prod_bronze.optimism_token_transfers
select
token_address,
from_address,
to_address,
...
block_hash,
amount_raw
from kf_optimism_token_transfers;
