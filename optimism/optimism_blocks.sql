...
CREATE TABLE kf_optimism_blocks
(
   ...
   number bigint
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_optimism_blocks',
...
SET 'pipeline.name' = 'optimism_blocks_sync';


-- submit job
insert into iceberg.prod_bronze.optimism_blocks
select
    base_fee_per_gas,
    transaction_count,
