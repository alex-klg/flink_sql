...
-- Define table
-- 在 trino 执行 show ca
CREATE TABLE kf_fantom_transactions
(
   hash STRING,
   nonce bigint,
   ...
   receipt_effective_gas_price bigint
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_fantom_transactions',
...
SET 'pipeline.name' = 'fantom_transactions_sync';
...
-- select * from kf_fantom_transactions;
insert into iceberg.beta_bronze.fantom_transactions
select
