...
CREATE TABLE kf_fantom_token_transfers
(
   ...
   block_hash varchar
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_fantom_token_transfers',
...
SET 'pipeline.name' = 'fantom_token_transfers_sync';


-- submit job
insert into iceberg.beta_bronze.fantom_token_transfers
select
token_address,
from_address,
to_address,
...
block_hash,
amount_raw
from kf_fantom_token_transfers;