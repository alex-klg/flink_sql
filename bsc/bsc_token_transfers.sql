...
CREATE TABLE kf_bsc_token_transfers
(
   ...
   block_hash varchar
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_bsc_token_transfers',
...
SET 'pipeline.name' = 'bsc_token_transfers_sync';


-- submit job
insert into iceberg.beta_bronze.bsc_token_transfers
select
token_address,
from_address,
to_address,
