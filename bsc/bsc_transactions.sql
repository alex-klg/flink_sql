...
-- Define table
-- 在 trino 执行 show ca
CREATE TABLE kf_bsc_transactions
(
   hash STRING,
   nonce bigint,
   ...
   receipt_effective_gas_price bigint
    ...
    'connector' = 'kafka',
    'topic' = 'chain_data_bsc_transactions',
...
SET 'pipeline.name' = 'bsc_transactions_sync';

insert into iceberg.beta_bronze.bsc_transactions
select
